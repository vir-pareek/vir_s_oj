...
//   // Separate state for the dynamic test cases
//   const [testCases, setTestCases] = useState([]);

//   useEffect(() => {
//     // Fetch questions if they aren't loaded yet
//     if (status === "idle") {
...
//       if (questionToEdit) {
//         // Populate the main form state
//         setForm({
//           qid: questionToEdit.qid,
//           title: questionToEdit.title,
//           description: questionToEdit.description,
//           sampleInput: questionToEdit.sampleInput,
//           sampleOutput: questionToEdit.sampleOutput,
//           constraints: questionToEdit.constraints,
//           company: questionToEdit.company,
//         });
//         // Populate the test cases state, ensuring it's an array
